...
FLAGS = flags.FLAGS
#flags.DEFINE_string('postgres_db_spec','postgres://exit_speed:faster@localhost:/exit_speed','Postgres URI connection string.')
flags.DEFINE_string('postgres_db_spec','postgres://vudev:vudev@localhost:/exit_speed','Postgres URI connection string.')
